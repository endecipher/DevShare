...
//Will not allow to use history
import { connect } from 'react-redux';
import PropTypes from 'prop-types';
import { modifyProfile, getCurrentProfile } from '../../actions/profile';
...
const EditProfile = ({
    ...
    const onSubmit = e => {
        e.preventDefault();
        modifyProfile(formData, history, true);
    };
...
export default connect(mapStateToProps, {modifyProfile, getCurrentProfile})(withRouter(EditProfile))
